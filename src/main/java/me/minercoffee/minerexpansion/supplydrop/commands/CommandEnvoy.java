    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, String[] args) {
        if (sender instanceof Player) {
                ...
                if (p.hasPermission("miner.staff")) {
                    ...
                    int z = (int) pLoc.getZ();
                    String var9;
                    switch ((var9 = args[0]).hashCode()) {
                        case -1352294148:
                            if (var9.equals("create")) {
                                if (args.length == 1) {
                        ...
                        case -1148096752:
                            if (var9.equals("adddrop")) {
                                ...
                                try {
                                    ...
                                    this.envoyCfg.set("envoys." + args[1] + ".drops." + args[2], chance);
                                    EnvoysDataManager.saveEnvoysData();
                        ...
                        case -974507682:
                            if (var9.equals("setdropcount")) {
                                ...
                                try {
                                    ...
                                    this.envoyCfg.set("envoys." + args[1] + ".dropCount", count);
                                    EnvoysDataManager.saveEnvoysData();
                        ...
                        case 109757538:
                            if (var9.equals("start")) {
                                ...
                                if (this.envoyCfg.get("envoys." + args[1] + ".pos1.x") != null && this.envoyCfg.get("envoys." + args[1] + ".pos2.x") != null) {
                                    ...
                                    int envoyLength = this.envoyCfg.getInt("envoys." + args[1] + ".length");
                                    ...
                                    (new BukkitRunnable() {
                                        ...
                                        public void run() {
                                            ...
                                            int rndLocX = CommandEnvoy.this.getRandomBetween(envoyPos1X, envoyPos2X);
                                            int rndLocZ = CommandEnvoy.this.getRandomBetween(envoyPos1Z, envoyPos2Z);
                                            int curHeight = 256;
                        ...
                        case 1291167176:
                            if (var9.equals("setlength")) {
                                ...
                                try {
                                    ...
                                    this.envoyCfg.set("envoys." + args[1] + ".length", length * 60 * 20);
                                    EnvoysDataManager.saveEnvoysData();
